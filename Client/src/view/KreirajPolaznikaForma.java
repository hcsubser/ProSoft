...
public class KreirajPolaznikaForma extends javax.swing.JFrame {
     ...
     */
     public KreirajPolaznikaForma(JFrame parent,Polaznik k) {
        ...
        inicijalizujPolja();
        if(k!=null){
            setTitle("Promeni polaznika");
            polaznik=k;
            pkf=(UpravljajPolaznicimaForma) parent;
            popuniIzmenuPolaznik(polaznik);
        }
    }
    ...
    private void initComponents() {
        ...
        txtTelefon.setBackground(new java.awt.Color(0, 0, 0));
        ...
        comboBoxMesto.setBackground(new java.awt.Color(0, 204, 255));
        comboBoxMesto.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        comboBoxMesto.setForeground(new java.awt.Color(0, 0, 0));

        btnMestoAdd.setBackground(new java.awt.Color(0, 204, 255));
        btnMestoAdd.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnMestoAdd.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btnMestoAdd, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addComponent(btnNazad, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 29, Short.MAX_VALUE)
                        .addComponent(btnSacuvaj, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(36, 36, 36))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnMestoAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void onWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_onWindowClosed
        UpravljajPolaznicimaForma pkf;
        try {
            pkf = new UpravljajPolaznicimaForma();
            pkf.setVisible(true);
            this.dispose();
        } catch (Exception ex) {
            Logger.getLogger(KreirajPolaznikaForma.class.getName()).log(Level.SEVERE, null, ex);
