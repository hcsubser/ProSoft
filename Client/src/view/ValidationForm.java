...
public class ValidationForm extends javax.swing.JDialog {
    ...
    private KreirajInstruktoraForma kf;
     ...
     */
    public ValidationForm(KreirajInstruktoraForma parent, Instruktor c) {
        super(parent, true);
        initComponents();
        this.instruktor = c;
        this.kf = (KreirajInstruktoraForma) parent;
        setLocationRelativeTo(null);
        setResizable(false);
        txtIme.setText(instruktor.getIme());
        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        setTitle("Validacija instruktora");
    ...
    private void btnValidateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidateActionPerformed
        ...
        System.out.println("pas:" + instruktor.getLozinka());
        String hashed = PasswordHash.hashPassword(pass);
        System.out.println("hashed:" + hashed);
        if (hashed.equals(instruktor.getLozinka())) {
